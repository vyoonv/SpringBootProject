...
//		 모든 필드를 초기화하지 않을 것이기 때문에 
//		 setter 이용해서 필요한 것만 생성 
...
//		uf.setFileRename(fileRename); 
		...
		// @Transactional(rollbackFor=Exception.class)로 모든 예외 발생시 롤백할 수 있도록 작성 
		// == 롤백할 예외 범위 수정 
